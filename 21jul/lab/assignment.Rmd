...
* Using min and max date in the data, create Good date field with continuous sequence of dates 
* Check Data field in Data against Goodly created data field and find missing values.
```{r, echo=T}
...
plot(train_TS, 
     ...
     main="Aggregated Montly Price Time series plot of 6399602 product - (Condition: Good)")
